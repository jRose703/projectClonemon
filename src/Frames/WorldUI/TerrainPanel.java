    ...
    public void paint(Graphics g) {
        ...
        for (int x = 0; x < X_FIELDS; x++)
            for (int y = 0; y < Y_FIELDS; y++) {
                ...
                ImageIcon image = switch (map[x][y].getTexture_id()) {
                    case 0 -> new ImageIcon("assets/tiles/low_grass_tile.png");
                    case 1 -> new ImageIcon("assets/tiles/rock_tile.png");
                    case 2 -> new ImageIcon("assets/tiles/water_tile.png");
                    case 3 -> new ImageIcon("assets/tiles/door_tile.png");
                    default -> new ImageIcon("assets/tiles/void_tile.png");
                };
