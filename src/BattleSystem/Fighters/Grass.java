...
public class Grass extends Fighter {
    ...
    public Grass(String name, BattleParticipant battleParty, int ID, int maxHP, int attackStat, int defenseStat, int initStat, imageIcon backSprite, imageIcon fronSprite){
